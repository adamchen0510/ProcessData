...
time python mergetickzhubi.py lrc_tick.csv lrc_zhubi.csv lrc_output.csv
time python mergetickzhubi.py eth_tick.csv eth_zhubi.csv eth_output.csv
time python mergetickzhubi.py btc_tick.csv btc_zhubi.csv btc_output.csv

time python merge3coins.py btc_output.csv eth_output.csv lrc_output.csv binance.csv
