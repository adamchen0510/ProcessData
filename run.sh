...
time python mergetickzhubi.py lrc_tick.csv lrc_zhubi.csv lrc_output_raw.csv > log3
time python mergetickzhubi.py eth_tick.csv eth_zhubi.csv eth_output_raw.csv > log4
time python mergetickzhubi.py btc_tick.csv btc_zhubi.csv btc_output_raw.csv > log5

time python correcttime.py lrc_output_raw.csv lrc_output.csv > log31
time python correcttime.py eth_output_raw.csv eth_output.csv > log32
time python correcttime.py btc_output_raw.csv btc_output.csv > log33

time python merge3coins.py btc_output.csv eth_output.csv lrc_output.csv binance.csv > log6

time python csvtopickle.py binance.csv binance.pickle > log7
